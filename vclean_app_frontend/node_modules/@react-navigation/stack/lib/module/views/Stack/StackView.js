...
export class StackView extends React.Component {
  ...
  handleTransitionStart = (_ref5, closing) => {
    let {
      route
    } = _ref5;
  ...
  handleTransitionEnd = (_ref6, closing) => {
    let {
      route
    } = _ref6;
    return this.props.navigation.emit({
